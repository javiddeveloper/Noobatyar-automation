...
from appointment.views.service_breakdown_view import ServiceBreakdownView
...
urlpatterns = [
    ...
    path('service-breakdown/', ServiceBreakdownView.as_view(), name='appointment-service-breakdown'),
