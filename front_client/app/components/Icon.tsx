...
export const CATEGORY_ICON: Record<string, IconName> = {
  DOCTOR: 'medical',
  GENERAL_PRACTITIONER: 'medical',
  INTERNAL_MEDICINE: 'medical',
  CARDIOLOGY: 'medical',
  DERMATOLOGY: 'spa',
  ORTHOPEDICS: 'medical',
  PEDIATRICS: 'medical',
  ...
  DENTAL_IMPLANT: 'medical',
  PEDIATRIC_DENTISTRY: 'medical',
  PSYCHOLOGY: 'school',
  ...
  RADIOLOGY: 'medical',
  OPTOMETRY: 'medical',
  SPEECH_THERAPY: 'school',
  OCCUPATIONAL_THERAPY: 'fitness',
  MIDWIFERY: 'medical',
  NURSING: 'medical',
  PHARMACY: 'medical',
  VETERINARY: 'pets',
